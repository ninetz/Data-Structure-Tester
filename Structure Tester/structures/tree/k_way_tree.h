...
namespace structures
{
	...
	{
		//Nasledujuce zakomentovane metody z cvik padnu na stack overflow
		// za predpokladu ze strom dostatocne zdegeneruje
		...
		// Zabezpeci, ze destruktor nepadne na stack overflow
		// aj napriek tomu ze strom je zdegenerovany
