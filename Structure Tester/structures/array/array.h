...
namespace structures
{
	...
	Array<T>& Array<T>::operator=(const Array<T>& other)
	{
		if (this != &other) {
			...
			// dereferencia - pretoze inak priradime 2 pointery k 1 objektu a vznikne mem. leak
	...
	{
		// 4 kroky, prepocitam index, dostanem sa tam, pretypujem si to a pozriem sa na co to ukazuje
